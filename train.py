...
def create_features(df):
    ...
    df = df.copy()
    df['rd_value_scaled'] = df.groupby('symbol')['rd_value'].transform(
...
def main():
    ...
    # 2. Read the files from the flattened directory
    ...
    for f in files:
        ...
        # Extract the filename without '.csv' to use as the chunk ID
       	# Example: 'dataset_flattened/2026-02-10-2_A.csv' -> '2026-02-10-2_A'
    ...
    df_feat, feature_names = create_features(df_chunks)
